import {
  ...
  const thongBaoSinhVienLopHocPhanReducer = (
    state = initialState,
    { type, payload }
  ) => {
    switch (type) {
      case GETTHONGBAOSINHVIENS_LOPHOCPHAN_SUCCESS:
        state.data = payload;
        return { ...state };
  
      case GETTHONGBAOSINHVIENS_LOPHOCPHAN_FAILED:
        state.err = payload;
        return { ...state };
  ...
  export default thongBaoSinhVienLopHocPhanReducer;
